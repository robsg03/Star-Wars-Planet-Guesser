...
This is a basic trivia game that shuffles Star Wars planets in a random order and quizzes the user on their knowledge. Users must use hints and pictures of the planet to guess correctly. The objective is to earn the JEDI MASTER rank.
